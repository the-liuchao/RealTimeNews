...
public class ViewPagerIndicator extends LinearLayout {
    ...
    private void initTriangle() {
        mPath = new Path();
        int bottomWidth = getScreenWidth() / mTabVisibleCount;
        mTriangleHeight = (int) (mTriangleWidth / 2 / Math.sqrt(2));
        mPath.moveTo(0, 0);
        mPath.lineTo(bottomWidth, 0);
        mPath.lineTo(bottomWidth, -mTriangleHeight / 2);
        mPath.lineTo(bottomWidth / 2 + mTriangleWidth / 4, -mTriangleHeight / 2);
        mPath.lineTo(bottomWidth / 2, -mTriangleHeight);
        mPath.lineTo(bottomWidth / 2 - mTriangleWidth / 4, -mTriangleHeight / 2);
        mPath.lineTo(0, -mTriangleHeight / 2);
