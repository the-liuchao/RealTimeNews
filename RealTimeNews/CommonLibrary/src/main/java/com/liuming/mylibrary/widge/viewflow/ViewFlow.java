...
//				}
    ...
    private void snapToScreen(int whichScreen) {
        ...
        mScroller.startScroll(getScrollX(), 0, delta, 0, (int) (Math.abs(delta) * 0.5));
        invalidate();
    }
...
//			}
    ...
    public void setmSideBuffer(int mSideBuffer) {
        ...
        if (mIndicator != null) {
            CircleFlowIndicator circleFlowIndicator = (CircleFlowIndicator) this.mIndicator;
            LayoutParams params = circleFlowIndicator.getLayoutParams();
            params.width = circleFlowIndicator.measureWidth(circleFlowIndicator.getMeasuredWidth());
        }
    }
}
