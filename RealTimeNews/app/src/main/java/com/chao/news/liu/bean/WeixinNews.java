...
public class WeixinNews implements Serializable {
    @Column(name = "id", isId = true)
    private int id;
    @Column(name = "hottime")
    private String mHotTime;      //发生时间
    @Column(name = "title")
    ...
    public WeixinNews parser(String type, JSONObject jsonObject) {
        mHotTime = jsonObject.optString("hottime");
    ...
    public String getmHotTime() {
        if (mHotTime == null || "null".equals(mHotTime)) mHotTime = "";
        return mHotTime;
    }

    public void setmHotTime(String mHotTime) {
        this.mHotTime = mHotTime;
    }
